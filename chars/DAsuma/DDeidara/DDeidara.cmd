...
[State -1, AI Kamikadze]
type = ChangeState
value = 1212
triggerall = life <= 200
triggerall = Var(50) = 1
triggerall = random >= 250 && random < 299 || random >= 550 && random <= 999
triggerall = random >= 220 && random < 400 || random >= 560 && random <= 199
triggerall = p2life > 0
trigger1 = statetype = S
trigger1 = ctrl
