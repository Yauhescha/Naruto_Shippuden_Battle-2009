...
[State -1, AI Hand Yondaime Kazekage With Fog]
type = ChangeState
value = 1215
...
[State -1, AI Hand Yondaime Kazekage]
type = ChangeState
value = 1214
triggerall = power >= 3000
triggerall = Var(50) = 1
...
[State -1, Hand Yondaime Kazekage With Fog]
type = ChangeState
value = 1215
triggerall = power >= 4000
trigger1 = var(10) = 1
...
triggerall = Var(50) = 0
trigger1 = ctrl
trigger2 = stateno = 5001 || stateno = 5002

[State -1,Hand Yondaime Kazekage]
type = ChangeState
value = 1214
triggerall = power >= 3000
trigger1 = var(10) = 1
