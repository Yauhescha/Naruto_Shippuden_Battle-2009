...
; AI Chakra Scalpel Light
[State -1, AI Chakra Scalpel Light]
type = ChangeState
value = 1000
...
; AI Chakra Scalpel Hard
[State -1, AI Chakra Scalpel Hard]
type = ChangeState
value = 1200
...
value = 1235
triggerall = power >= 4000
triggerall = command = "KAB"
trigger1 = statetype = S
trigger1 = ctrl
;---------------------------------------------------------------------------
; Chakra Scalpel Hard
[State -1,Chakra Scalpel Hard]
type = ChangeState
value = 1200
triggerall = power >= 3000
