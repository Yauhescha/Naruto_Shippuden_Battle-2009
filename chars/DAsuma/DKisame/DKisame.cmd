...
triggerall = p2bodydist x > 20 && p2bodydist x <= 90
triggerall = Var(50) = 1
triggerall = random >= 250 && random < 299 || random >= 550 && random <= 999
triggerall = p2life > 0
trigger1 = statetype = s
...
[State -1, WATER Bunshin]
type = ChangeState
value = 1100
triggerall = power >= 1000
Triggerall = Numhelper(16000) < 2
triggerall = Var(50) = 1
triggerall = random >= 250 && random < 299 || random >= 550 && random <= 999
triggerall = p2life > 0
trigger1 = statetype = s
